...
<div class="container max-w-full mx-auto pt-4 ">
    ...
    <button  class=" bg-blue-500 tracking-wide text-white px-6 py-2 inline mb-6 shadow-lg rounded hover:shadow" type="submit" >اضافة تعليق</button>
    ...
    <h2  style="margin-bottom:10px"  class="text-x1 font-bold text-blue-900">التعليقات</h2>
